Player = World:newBSGRectangleCollider(WIDTH/2 - PLAYER_HITBOX_WIDTH/2, (HEIGHT/2 - PLAYER_HITBOX_HEIGHT/2) + SHIFTDOWN, PLAYER_HITBOX_WIDTH, PLAYER_HITBOX_HEIGHT, 10)
