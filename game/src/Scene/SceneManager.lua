...
function SceneManager:load()
  self.grounds = {
    ScrollingImage(180/2,GROUND_PADDING_POSITION,180,-100, Atlas:get("ground_top")),
    ScrollingImage(180/2,HEIGHT - GROUND_PADDING_POSITION,0,-100, Atlas:get("ground_top"))
  }
  self.undergrounds = {}
  for i = 0, GROUND_TILES, 1 do
    local offent = math.floor(GROUND_PADDING_POSITION + (GROUND_PADDING_POSITION) * i)
    
    table.insert(self.undergrounds, ScrollingImage(180/2, -offent, 180, -100, Atlas:get("ground_underground")))
